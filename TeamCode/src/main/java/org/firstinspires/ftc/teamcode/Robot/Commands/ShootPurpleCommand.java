...
public class ShootPurpleCommand extends CommandBase{
    private final FeederSubsystem m_feederSubsystem;
    private final TurresSubsystem m_turresSubsystem;
    private final ShooterSubsystem m_shooterSubsystem;

    public ShootPurpleCommand(FeederSubsystem feeder, TurresSubsystem turres, ShooterSubsystem shooter)
    {
    ...
    public void initialize()
    {
        ...
        {
            m_feederSubsystem.SetWantedState(FeederSubsystem.WantedState.FEED_PURPLE);
        }
    }
