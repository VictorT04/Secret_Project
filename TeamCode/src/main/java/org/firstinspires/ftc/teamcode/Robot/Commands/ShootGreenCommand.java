...
public class ShootGreenCommand extends CommandBase{
    ...
    public ShootGreenCommand(FeederSubsystem feeder, TurresSubsystem turres, ShooterSubsystem shooter)
    {
    ...
    public void initialize()
    {
        ...
        {
            m_feederSubsystem.SetWantedState(FeederSubsystem.WantedState.FEED_GREEN);
        }
    }
